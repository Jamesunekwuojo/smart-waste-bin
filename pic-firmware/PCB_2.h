...
// CCS C uses intN type names rather than the standard C99 fixed-width names.
#define uint8_t  int8
...
// Baud rate set to 2400 for high stability across level-shifted connection to the ESP32.
