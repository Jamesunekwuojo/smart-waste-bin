 ...
 *   4. An I2C character LCD display to show bin capacities and server predictions.
...
// =========================================================================
// 1. HARDWARE PIN CONFIGURATIONS (ESP32-CAM Friendly Pins)
// =========================================================================
// Since the ESP32-CAM uses almost all pins for the camera and SD card,
// we utilize the remaining free pins carefully:

#define BUTTON_PIN      12   // Active-LOW trigger button (with internal pull-up)
#define I2C_SDA         14   // SDA line for LiquidCrystal LCD
#define I2C_SCL         13   // SCL line for LiquidCrystal LCD
#define PIC_RX_PIN      16   // ESP32 RX2 Pin (receives data from PIC TX)
#define PIC_TX_PIN      15   // ESP32 TX2 Pin (sends data to PIC RX)
...
// Setup I2C LCD (Standard address 0x27, 16 columns by 2 rows)
...
void setup() {
  ...
  // Initialize Custom I2C Bus and LCD Display
...
void loop() {
  ...
  // 3. Scan the trigger button (Active-LOW, check for press transition)
